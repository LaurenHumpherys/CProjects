...
int main(void) {
    char filename[] = "C:\\Users\\C22Lauren.Humpherys\\CLionProjects\\CProjects\\Labs\\Lesson28\\Employee_Recs.txt";
...
//          array. The character array may contain spaces and punctuation.
  /*  char* inputString;
    int numVowels = numVowels(*inputString);
    printf("%d", numVowels);*/
   ...
   /* char *newString = sortString("ThIs Is A sTrIng.");
    ...
    //      from the text file.
        ...
        char* employeeData = malloc(sizeof(char) * strlen(filename));
